...
Namespace OAuth
	Public Class OAuthBase
		...
		Public Function GenerateSignatureBase(ByVal url As Uri, ByVal consumerKey As String, ByVal token As String, ByVal tokenSecret As String, ByVal httpMethod As String, ByVal timeStamp As String, _
            ...
            Return GenerateSignatureBase(url, consumerKey, token, tokenSecret, String.Empty, String.Empty,  httpMethod, timeStamp, nonce, signatureType, normalizedUrl, normalizedRequestParameters)
        End Function
		...
		''' <param name="token">The token, if available. If not available pass null or an empty string</param>
		''' <param name="tokenSecret">The token secret, if available. If not available pass null or an empty string</param>
		''' <param name="callback">Callback URL. If not available pass null or an empty string</param>
		''' <param name="verifier">Verifier. If not available pass null or an empty string</param>
		''' <param name="httpMethod">The http method used. Must be a valid HTTP method verb (POST,GET,PUT, etc)</param>
		''' <param name="signatureType">The signature type. To use the default values use <see cref="OAuthBase.SignatureTypes">OAuthBase.SignatureTypes</see>.</param>
		''' <returns>The signature base</returns>
		Public Function GenerateSignatureBase(ByVal url As Uri, ByVal consumerKey As String, ByVal token As String, ByVal tokenSecret As String, ByVal callback As String, _
		                                      ByVal verifier As String, ByVal httpMethod As String, ByVal timeStamp As String, _
			                                  ByVal nonce As String, ByVal signatureType As String, ByRef normalizedUrl As String, ByRef normalizedRequestParameters As String) As String
		...
		''' <param name="httpMethod">The http method used. Must be a valid HTTP method verb (POST,GET,PUT, etc)</param>
		''' <returns>A base64 string of the hash value</returns>
		Public Function GenerateSignature(ByVal url As Uri, ByVal consumerKey As String, ByVal consumerSecret As String, ByVal token As String, ByVal tokenSecret As String, _
		                                  ByVal callback As String, ByVal verifier As String, ByVal httpMethod As String, _
			...
			Return GenerateSignature(url, consumerKey, consumerSecret, token, tokenSecret, callback, verifier, httpMethod, _
		...
		''' <returns>A base64 string of the hash value</returns>
		Public Function GenerateSignature(ByVal url As Uri, ByVal consumerKey As String, ByVal consumerSecret As String, ByVal token As String, ByVal tokenSecret As String, ByVal callback As String, ByVal verifier As String, httpMethod As String, _
			...
			Select Case signatureType
				...
				Case SignatureTypes.HMACSHA1
					Dim signatureBase As String = GenerateSignatureBase(url, consumerKey, token, tokenSecret, callback, verifier, httpMethod, timeStamp, _
					...
					Return UrlEncode(GenerateSignatureUsingHash(signatureBase, hmacsha1))
